 ...
 * line in the file reporesents one song. Each line in the file is processed
  ...
  */
  ...
  // TODO 1: Implement this method.
     ...
     if(tokens[1].trim().isEmpty())
         songs.addSong(new Song(tokens[0].trim(), tokens[2].trim(), Double.parseDouble(tokens[3].trim())));
     else
         songs.addSong(new Song(tokens[0].trim(), tokens[1].trim(), tokens[2].trim(),Double.parseDouble(tokens[3].trim())));
